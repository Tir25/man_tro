...
/**
 * Tech chip data structure for the tech stack display
 */
...
export const frontendTechs: TechChip[] = [
    {
        name: 'React',
        icon: (
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 394 80" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M262 0h68.5v12.7h-27.2v66.6h-13.6V12.7H262V0zm-81.5 0H249v12.7h-13.6v53.9c0 7.1 3.2 10.7 9.5 10.7 3.2 0 5.4-.8 7.6-2.1l5.4 11.3c-3.2 2.1-8.1 3.6-13.6 3.6-13.6 0-22.6-7.1-22.6-20.3V12.7h-13.6V0zm-94.6 12.7H99c-7.6 0-13.6 5.4-13.6 13.6v40.7c0 7.6 6 13.6 13.6 13.6h12.7c7.6 0 13.6-6 13.6-13.6V26.3c0-7.6-6-13.6-13.6-13.6zm-1.4 13.6v40.7c0 1.4-1.4 2.8-2.8 2.8H90c-1.4 0-2.8-1.4-2.8-2.8V26.3c0-1.4 1.4-2.8 2.8-2.8h12.7c1.4 0 2.8 1.4 2.8 2.8z" fill="currentColor" />
                <path d="M0 0h68.5v12.7H27.2v27.2h35.6v12.7H27.2v27.2h41.3V80H0V0z" fill="currentColor" />
            </svg>
        ),
        color: '#000000',
        category: 'frontend',
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622h10.125l-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.955-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z" fill="currentColor" />
            </svg>
        ),
        color: '#1572B6',
        category: 'frontend',
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M12 6c-2.67 0-4.33 1.33-5 4 1-1.33 2.17-1.83 3.5-1.5.76.19 1.31.74 1.91 1.35.98 1 2.12 2.15 4.59 2.15 2.67 0 4.33-1.33 5-4-1 1.33-2.17 1.83-3.5 1.5-.76-.19-1.31-.74-1.91-1.35C15.61 7.15 14.47 6 12 6zm-5 6c-2.67 0-4.33 1.33-5 4 1-1.33 2.17-1.83 3.5-1.5.76.19 1.31.74 1.91 1.35.98 1 2.12 2.15 4.59 2.15 2.67 0 4.33-1.33 5-4-1 1.33-2.17 1.83-3.5 1.5-.76-.19-1.31-.74-1.91-1.35C10.61 13.15 9.47 12 7 12z" fill="currentColor" />
            </svg>
        ),
        color: '#06B6D4',
        category: 'frontend',
...
export const mobileTechs: TechChip[] = [
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M1.63636 0L12 12.5455L22.3636 0H24L12 14.1818L0 0H1.63636ZM0 16.3636L12 30.5455L24 16.3636V24L12 38.1818L0 24V16.3636Z" fill="currentColor" />
            </svg>
        ),
        color: '#7F52FF',
        category: 'mobile',
...
export const backendTechs: TechChip[] = [
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M14.38 2.58a2.49 2.49 0 0 0-1.77.73 2.6 2.6 0 0 0-.73 1.78v1.28H5.58a2.49 2.49 0 0 0-1.77.73 2.6 2.6 0 0 0-.73 1.78v3.83a2.6 2.6 0 0 0 .4 1.34 2.49 2.49 0 0 0 1.1.99c.26.1.53.15.8.15h.7v-1.1a3.32 3.32 0 0 1 3.3-3.3h3.95a1.66 1.66 0 0 0 1.66-1.65V5.09a2.6 2.6 0 0 0-.73-1.78 2.49 2.49 0 0 0-1.78-.73zm.72 1.43a.83.83 0 0 1 .83.83.83.83 0 0 1-.83.83.83.83 0 0 1-.83-.83.83.83 0 0 1 .83-.83z" fill="currentColor" />
                <path d="M9.62 21.42a2.49 2.49 0 0 0 1.77-.73 2.6 2.6 0 0 0 .73-1.78v-1.28h6.3a2.49 2.49 0 0 0 1.77-.73 2.6 2.6 0 0 0 .73-1.78v-3.83a2.6 2.6 0 0 0-.4-1.34 2.49 2.49 0 0 0-1.1-.99 2.47 2.47 0 0 0-.8-.15h-.7v1.1a3.32 3.32 0 0 1-3.3 3.3H9.27a1.66 1.66 0 0 0-1.66 1.65v2.47a2.6 2.6 0 0 0 .73 1.78 2.49 2.49 0 0 0 1.78.73zm-.72-1.43a.83.83 0 0 1-.83-.83.83.83 0 0 1 .83-.83.83.83 0 0 1 .83.83.83.83 0 0 1-.83.83z" fill="currentColor" />
            </svg>
        ),
        color: '#3776AB',
        category: 'backend',
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M8.5 8.5h1.5c.5 0 .9.4.9.9v5.2c0 .5-.4.9-.9.9H8.5c-.5 0-.9-.4-.9-.9V9.4c0-.5.4-.9.9-.9zm.9 1.8v3.6h.6v-3.6h-.6zm3.6-1.8h1.5c.5 0 .9.4.9.9v5.2c0 .5-.4.9-.9.9h-1.5c-.5 0-.9-.4-.9-.9V9.4c0-.5.4-.9.9-.9zm.9 1.8v3.6h.6v-3.6h-.6z" fill="currentColor" />
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" preserveAspectRatio="xMidYMid meet">
                <path d="M21.362 9.354H12V.396a.396.396 0 0 0-.716-.233L2.203 12.424l-.401.562a1.04 1.04 0 0 0 .836 1.659H12v8.959a.396.396 0 0 0 .716.233l9.081-12.261.401-.562a1.04 1.04 0 0 0-.836-1.66z" fill="currentColor" />
            </svg>
        ),
        color: '#3ECF8E',
        category: 'backend',
...
// Combined tracks for marquee display
export const topTrackTechs = [...frontendTechs, ...mobileTechs]
export const bottomTrackTechs = backendTechs

/**
 * Utility to duplicate array for seamless marquee loop
 */
export function duplicateArray<T>(arr: T[], times: number = 2): T[] {
...
/**
 * Creates animation variants for marquee motion
 */
export function createMarqueeVariants(direction: 'forward' | 'reverse', distance: number = 1000) {
    return {
        animate: {
